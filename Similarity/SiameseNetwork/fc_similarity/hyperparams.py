...
"""
    ...
    @Description:       params for transformer
"""
...
class Hyperparams:
    ...
    num_epochs = 30
    num_heads = 6   # number for multi-head self-attention
    dropout_keep_rate = 0.5
    hidden_size = emb_size  # hidden size (must equal to emb_size)
    ff_size = 256   # feed_forword node size
    fc_size = [1024, 512, 256]   # fc layer node size
